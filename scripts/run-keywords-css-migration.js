...
async function run() {
  ...
  try {
    ...
    const migPath = path.resolve(process.cwd(), "supabase/migrations/20260716000000_add_keyword_css_and_publish_date.sql");
    console.log(`\n📄 Reading migration: ${migPath}...`);
    const sql = fs.readFileSync(migPath, "utf-8");
    
    console.log("🚀 Executing SQL migration...");
    await client.query(sql);
    console.log("✅ Keywords CSS and Publish Date migration applied successfully!");
  } catch (err) {
