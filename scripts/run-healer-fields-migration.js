...
async function run() {
  ...
  try {
    ...
    const migPath = path.resolve(process.cwd(), "supabase/migrations/20260615040000_healer_fields_and_expertise.sql");
    console.log(`\n📄 Reading migration: ${migPath}...`);
    const sql = fs.readFileSync(migPath, "utf-8");
    
    console.log("🚀 Executing SQL migration...");
    await client.query(sql);
    console.log("✅ Healer fields and expertise migration applied successfully!");
  } catch (err) {
