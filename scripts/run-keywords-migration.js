...
async function run() {
  ...
  try {
    ...
    const migPath = path.resolve(process.cwd(), "supabase/migrations/20260615030000_keywords_and_service_fields.sql");
    console.log(`\n📄 Reading migration: ${migPath}...`);
    const sql = fs.readFileSync(migPath, "utf-8");
    
    console.log("🚀 Executing SQL migration...");
    await client.query(sql);
    console.log("✅ Keywords and services migration applied successfully!");
  } catch (err) {
