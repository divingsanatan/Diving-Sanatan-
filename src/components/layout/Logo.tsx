    ...
    <div className="ds-logo-container">
      ...
      >
        <defs>
          ...
          <linearGradient id="dsGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#e11d48" /> {/* Vibrant rose-red */}
            <stop offset="50%" stopColor="#9f1239" /> {/* Deep crimson */}
            <stop offset="100%" stopColor="#4c0519" /> {/* Dark maroon */}
          </linearGradient>
          {/* Subtle shadow glow */}
        ...
        {/* Outer Circular Elements - Two Hands Nesting/Wrapping */}
        {/* Upper Hand (Wrapping clockwise from top-left to top-right) */}
        <path
        ...
        {/* Lower Hand (Wrapping clockwise from bottom-right to bottom-left) */}
        <path
      ...
      {showText && (
        <div className="ds-logo-text-col">
          <span className="ds-logo-title" style={{ color: textColor }}>
            DIVING SANATAN
          </span>
          <span className="ds-logo-subtitle" style={{ color: subTextColor }}>
            HOLISTIC LIFE HEALING & PROBLEM SOLVING
          </span>
        </div>
      )}
